...
config["postgis"]["host"]     = "osm-db.cdebjzhnrxok.us-east-1.rds.amazonaws.com"
config["postgis"]["port"]     = ""
config["postgis"]["dbname"]   = "osm"
config["postgis"]["user"]     = "root"
config["postgis"]["password"] = "password"
...
config["processed_p"] = path.join(getcwd(),"../data/coastline-good.zip")
config["shoreline_300"] = path.join(getcwd(),"../data/shoreline_300.zip")
# http://mapbox-geodata.s3.amazonaws.com/natural-earth-1.3.0/physical/10m-land.zip
config["land"] = path.join(getcwd(),"../data/10m-land.zip")
